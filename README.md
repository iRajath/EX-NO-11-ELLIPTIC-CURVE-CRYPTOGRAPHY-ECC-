...
int main() {
    ...
    printf("Enter Rajath's private key: ");
    scanf("%lld", &privateA);
    printf("Enter Abishek's private key: ");
    scanf("%lld", &privateB);
...
<img width="1561" height="1055" alt="image" src="https://github.com/user-attachments/assets/00e24cec-61fb-4a2a-9ec4-432161dc04f9" />
